...
const routes: Routes = [
  ...
  { path: 'cl-list/:query', component: CraigslistListComponent, canActivate: [CanActivateViaAuthGuard] },
  { path: 'property/:addr', component: PropertyComponent, canActivate: [CanActivateViaAuthGuard] },
  { path: 'property/preview/:addr', component: PropertySplashComponent, canActivate: [CanActivateViaAuthGuard] },
